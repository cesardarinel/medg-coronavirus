...
var texto1 = "USTED NO NECESITA ASISTIR A CENTRO DE SALUD NI REALIZARSE EL TEST",
    ...
    boton = "<br> <input type='submit' value='Refrescar' onclick='location.reload()'></input>",
...
function valida() {
    ...
    document.getElementById("a1").checked && (e = !0, msj += "%0Acontacto", t += 1, r += cc),
     r += resul2,
     r += resul3, 
    document.getElementById("b1").checked && (a = !0, msj += "%0Asintomas",t += 1, r += sing, i = !0 ,t2+=1), 
    document.getElementById("c1").checked && (o = !0, msj += "%0Aproblema%20al%20respirar", t += 1, i = !0,t2+=1),
     document.getElementById("d1").checked && (s = !0, msj += "%0Afiebre", t += 1, i = !0,t2+=1),
     i && (r += sing),
     r += resul4, 
     r += resul5, 
     r += resul6, 
